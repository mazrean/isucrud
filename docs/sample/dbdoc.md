...
graph LR
  ...
  linkStyle 0,1,4,5,6,8,9,14,19,23,26,30,32 stroke:#78909C,stroke-width:2px
  linkStyle 2,3,7,10,12,13,15,17,20,22,24,25,27,28,29,31 stroke:#BBDEFB,stroke-width:2px
  linkStyle 11,16,18 stroke:#CDDC39,stroke-width:2px
